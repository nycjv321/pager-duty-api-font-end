...
(function() {
  ...
  $(document).ready(function() {
    ...
    $(".main").on("click", ".note-button", function() {
      ...
      if ($(".main").find("#" + incident_id + "_notes").size() === 0) {
        return $.ajax({
          ...
          dataType: 'json',
          success: function(data) {
            var note, note_count, note_html, _i, _len;
            if (data.length === 0) {
              ...
              return row.after("            <tr id=\"" + incident_id + "_notes" + "\" class=\"notes\"><td></td>              <td td colspan=\"7\">                <table class=\"table table-hover table-condensed table-bordered\">                <tr><th>#</th><th colspan=\"7\">Message</th></tr>                " + note_html + "                </table>              </td>            </tr>              ");
            }
          }
        });
      } else {
    ...
    return $(".main").on("click", "#saved_searches button", function(event) {
      var already_exists, history, instance, name, pagerDutyHistory, _i, _len;
      event.preventDefault();
